...
import com.JGG.Section43.Account;
...
public class MyDemoLoggingAspect {
    ...
    //331, 338 JoinPoint
    @Before("com.JGG.Section43.aspect.AopExpressions.forDaoPackage()") // before the pointcut
    ...
    //334
    @Before("com.JGG.Section43.aspect.AopExpressions.forDaoPackageExcludingSetter()")
    ...
    @AfterReturning(
            pointcut ="execution(* com.JGG.Section43.DAO.AccountDAO.findAccounts(..))",
            returning ="result")
    ...
    //348 afterfinally
    @After("execution(* com.JGG.Section43.DAO.AccountDAO.findAccounts(..))")
