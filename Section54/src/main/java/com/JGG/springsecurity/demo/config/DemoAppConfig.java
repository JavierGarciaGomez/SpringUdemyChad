...
public class DemoAppConfig {
    ...
    public DataSource securityDataSource(){
        ...
        securityDataDource.setMinPoolSize(getIntProperty("connection.pool.initialPoolSize"));
        securityDataDource.setMaxPoolSize(getIntProperty("connection.pool.initialPoolSize"));
        securityDataDource.setMaxIdleTime(getIntProperty("connection.pool.initialPoolSize"));
