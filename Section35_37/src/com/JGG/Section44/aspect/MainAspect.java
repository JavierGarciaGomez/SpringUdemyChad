package com.JGG.Section44.aspect;

import com.JGG.Section44.Account;
...
public class MyDemoLoggingAspect {
    ...
    //331, 338 JoinPoint
    @Before("com.JGG.Section44.aspect.AopExpressions.forDaoPackage()") // before the pointcut
    ...
    //334
    @Before("com.JGG.Section44.aspect.AopExpressions.forDaoPackageExcludingSetter()")
    ...
    @AfterReturning(
            pointcut ="execution(* com.JGG.Section44.DAO.AccountDAO.findAccounts(..))",
            returning ="result")
    ...
    //348 afterfinally
    @After("execution(* com.JGG.Section44.DAO.AccountDAO.findAccounts(..))")
    public void afterFinallyAdvice(JoinPoint joinPoint){
        String method = joinPoint.getSignature().toShortString();
        System.out.println("348. Im executing @After (finally) on method: "+method);
    }
